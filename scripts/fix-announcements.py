...
# Remove accidental typo tags if present
content = content.replace("motionLayout", "REMOVED")
content = content.replace("<REMOVED>", "").replace("</REMOVED>", "")

path = r"c:\Users\om\Desktop\sports-sync-ai\app\district\announcements\page.tsx"
